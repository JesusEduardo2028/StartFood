  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved plate as @plate" do
        ...
        post :create, {:plate => { "name" => "invalid value" }}, valid_session
        assigns(:plate).should be_a_new(Plate)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested plate" do
        ...
        Plate.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => plate.to_param, :plate => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the plate as @plate" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Plate.any_instance.stub(:save).and_return(false)
        put :update, {:id => plate.to_param, :plate => { "name" => "invalid value" }}, valid_session
        assigns(:plate).should eq(plate)
      end
